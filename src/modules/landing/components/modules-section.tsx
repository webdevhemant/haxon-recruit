...
export function ModulesSection() {
  return (
    <section id="modules" className="relative mx-auto max-w-6xl px-6 py-28">
      ...
      <div className="border-white/8 bg-white/8 grid grid-cols-1 gap-px overflow-hidden rounded-2xl border sm:grid-cols-2 lg:grid-cols-3">
        {LANDING_MODULES.map((m) => (
          <article
            key={m.no}
            className="group relative bg-[#0a0a0d] p-7 transition-colors hover:bg-[#0f0f15]"
          >
